...
public class Test1 {
	...
	public void setEnv() {
		System.setProperty("webdriver.chrome.driver",
				"D:\\SELENIUM_AUTOMATION_TESTING\\SOFTWARE\\ChromeDriver110\\chromedriver.exe");
...
//		}
	...
	public void Filter_by_Nonstop_and_validate_count() throws Exception {
		...
		driver.findElement(By.xpath("//p[contains(text(),'Stops From ')]/following-sibling::div/div[1]/label/div/p")).click();
		String str = driver.findElement(By.xpath("//p[contains(text(),'Stops From ')]/following-sibling::div/div[1]/label/div/p")).getText();
